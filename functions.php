        ...
        <article id="post" class="posts-entry fbox blogposts-list post type-post status-publish format-standard hentry">
            <div class="blogposts-list-content">
                ...
                <?php if ($detect->isMobile()): ?>
                    <a href="<?php echo $itemResult->href;?>" target="_blank" rel="bookmark"><img class="anons-list" src="<?php echo $itemResult->img;?>" width="80" height="80" style="object-fit: contain; background-color: #dcdcdc;"></a>
                    <header class="entry-header">
                <?php else: ?>
                    <a href="<?php echo $itemResult->href;?>" target="_blank" rel="bookmark"><img class="anons-list" src="<?php echo $itemResult->img;?>" width="80" height="80" style="object-fit: <?php echo $cover;?>; width: 80px; height: 80px;background-color: #dcdcdc;"></a>
                    <header class="entry-header">
...
function getSocialHtml(){
	  $html = '<div class="pu10 pd10 borderdown">
               ...
               <li class="fb-share social-button" style="width:70px;"><a rel="nofollow" title="Поделиться в Facebook" href="//www.facebook.com/dialog/share?app_id=406317839387165&amp;utm_source=fbsharing&amp;utm_medium=social&amp;href=http://domtradera.ru/" target="_blank" style="width: 70px; height: 30px;"><span class="fb_counter" style="display: table;">8</span></a></li>
                <li class="vk-share social-button"><a rel="nofollow" title="Поделиться в Vkontakte" href="//vk.com/share.php?utm_source=vksharing&amp;utm_medium=social&amp;url=https://www.gazeta.ru/politics/2019/01/28_a_12148573.shtml" target="_blank"><span class="vk_counter"></span></a></li>
                <li class="ok-share social-button"><a rel="nofollow" class="soc_ok" title="Поделиться в Одноклассники" href="//www.odnoklassniki.ru/dk?utm_source=oksharing&amp;utm_medium=social&amp;st.cmd=addShare&amp;st.s=1&amp;st._surl=https://www.gazeta.ru/politics/2019/01/28_a_12148573.shtml" target="_blank"><span class="ok_counter"></span></a></li>
                 <li class="twi-share social-button"><a rel="nofollow" class="soc_twi" title="Поделиться в Twitter" href="//twitter.com/intent/tweet?via=gazetaru&amp;utm_source=twsharing&amp;utm_medium=social&amp;url=https://www.gazeta.ru/politics/2019/01/28_a_12148573.shtml" target="_blank"></a></li>
                 </ul>
                </div>' . '</br>';
    $html.= '<div class="article-share-name"> 
                Присоединяйтесь к нашим сообществам
                <ul class="social-button-block1">
                 <li id="social-scroll"><li class="b-social">
                <li class="fb-share social-button1"> <a rel="nofollow" href="https://www.facebook.com/domtradera/" title="Facebook" class="ooidx b-social-icon fb_i_v2" target="_blank"></a></li>
                 <li class="vk-share social-button1"><a rel="nofollow" href="https://vk.com/domtradera" title="ВКонтакте" class="vk_i_v2 cpzeqo b-social-icon" target="_blank"></a></li>
                <li class="ok-share social-button1"> <a rel="nofollow" href="https://www.ok.ru/group/55222905143410/" title="Одноклассники" class="ok_i_v2 b-social-icon kebk" target="_blank"></a></li>
                <li class="ins-share social-button1"> <a rel="nofollow" href="https://www.instagram.com/domtradera" title="Instagram" class="b-social-icon waif mail_i_v2" target="_blank"></a></li>
                 <li class="tw-share social-button1"><a rel="nofollow" href="https://twitter.com/domtradera" title="Twitter" class="vckn b-social-icon tw_i_v2" target="_blank"></a></li>
                <li class="dzen-share social-button1"> <a rel="nofollow" href="https://zen.yandex.ru/id/5bf28e70ce919800abda5a45" title="Яндекс Дзен" class="zen_i_v2 b-social-icon dozt" target="_blank"></a></li>
                 <li class="tg-share social-button1"><a rel="nofollow" href="tg://resolve?domain=&lt;domtradera&gt;" title="Telegram" class="telegram_i_v2 sbtwue b-social-icon" target="_blank"></a></li>
                <li class="what-share social-button1"> <a rel="nofollow" href="https://chat.whatsapp.com/EqGaNEO93Jr3fcCRPqYNmh" title="WhatsApp" class="rss_i_v2 b-social-icon ufthisy" target="_self"></a></li>
                 <li class="vi-share social-button1"><a rel="nofollow" href="https://invite.viber.com/?g2=AQBvYGUohi9ebkjdFGDJW7QLCTv3oJILFUi0tCa1SwR7xBMhI99HQlhaVyVpOg3l&amp;lang=ru" title="Viber" class="b-social-icon xbqzz youtube_i_v2" target="_blank"></a></li>
               </ul>             
               </div>
               </div>';
	return $html;
